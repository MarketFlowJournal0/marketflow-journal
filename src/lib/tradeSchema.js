...
export const CANONICAL_TRADE_FIELDS = [
  ...
  { value: 'result', label: 'Result (TP / BE / SL)', aliases: ['result', 'resultat', 'outcome', 'status', 'winloss', 'closedreason', 'closereason'] },
  { value: 'rrActual', label: 'R:R', aliases: ['rr', 'r', 'riskreward', 'rrratio', 'rractual', 'rrreel', 'multiple', 'rmultiple'] },
  { value: 'pnl', label: 'P&L', aliases: ['pnl', 'pl', 'profitloss', 'profit_loss', 'profit', 'netprofit', 'netpl', 'gainloss', 'realizedpnl', 'realizedpl'] },
