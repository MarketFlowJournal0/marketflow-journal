      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-[#1E2536] rounded-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto border border-[#2D3548]"
          >
            {/* Header */}
            <div className="sticky top-0 bg-[#1E2536] border-b border-[#2D3548] p-6 flex items-center justify-between z-10">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button onClick={onClose} className="text-[#A0AEC0] hover:text-white text-2xl transition">×</button>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <motion.div 
                    ...
                    className="bg-[#1A1F2E] rounded-lg p-5 border border-[#2D3548]"
                  >
                        ...
                        <div className="relative">
                          ...
                          {showConfluenceDropdown && (
                            <motion.div 
                              ...
                              animate={{ opacity: 1, y: 0 }}
                              className="absolute top-full left-0 mt-2 w-64 bg-[#1E2536] border border-[#2D3548] rounded-lg shadow-xl z-20 max-h-64 overflow-y-auto"
                            >
                              {confluences
              ...
              {trade.psychology?.issues && trade.psychology.issues.length > 0 && (
                <motion.div 
                  ...
                  className="bg-[#7F1D1D]/20 rounded-lg p-5 border border-[#DC2626]"
                >
