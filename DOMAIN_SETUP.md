...
- `https://marketflowjournal.com` is the public marketing site and primary domain.
- `https://www.marketflowjournal.com` redirects permanently to `https://marketflowjournal.com`.
...
- `marketflowjournal.com` as the primary production domain.
- `www.marketflowjournal.com` attached with a Vercel redirect to `marketflowjournal.com`.
...
```env
REACT_APP_SITE_URL=https://marketflowjournal.com
...
PUBLIC_SITE_URL=https://marketflowjournal.com
...
- `https://marketflowjournal.com` loads only the landing page, even for a signed-in user.
